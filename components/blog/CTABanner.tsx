...
function GoldenShimmerBadge() {
  return (
    <div className="relative bg-gradient-to-br from-slate-900 via-slate-900 to-slate-900 rounded-2xl p-8 border border-sky-500/30 overflow-hidden">
      ...
      <div className="relative z-10 text-center">
        <Gift className="text-sky-500 mx-auto mb-4" size={48} />
...
export default function CTABanner({
  ...
  if (variant === 'whatsapp') {
    return (
      <div className="my-10 bg-gradient-to-r from-sky-500 to-sky-600 rounded-2xl overflow-hidden shadow-xl">
  ...
  if (variant === 'inline') {
    return (
      <div className="my-8 p-5 bg-gradient-to-r from-sky-50 to-sky-50 rounded-xl border-l-4 border-sky-500">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-start gap-3">
            <Sparkles className="text-sky-500 flex-shrink-0 mt-0.5" size={24} />
            <div>
          ...
          <Link
            href="/tienda/"
            className="bg-sky-500 hover:bg-sky-600 text-white px-5 py-2.5 rounded-lg font-semibold text-sm transition-colors flex items-center gap-2 whitespace-nowrap"
          >
            Ver productos
            <ArrowRight size={16} />
          </Link>
  ...
  if (variant === 'secondary') {
    return (
      <div className="my-10 bg-slate-900 rounded-2xl overflow-hidden">
        <div className="p-8 md:p-10">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <span className="inline-flex items-center gap-2 bg-sky-500/20 text-sky-500 px-3 py-1 rounded-full text-sm font-medium mb-4">
                <Gift size={14} />
                Catálogo 2025
              </span>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/tienda/"
                  className="bg-sky-500 hover:bg-sky-600 text-white px-6 py-3 rounded-lg font-bold transition-colors flex items-center justify-center gap-2"
                >
                  <ShoppingBag size={18} />
                  Explorar Tienda
                </Link>
  ...
  return (
    <div className="my-12 relative overflow-hidden rounded-3xl bg-gradient-to-br from-navy-900 via-navy-600 to-navy-900 shadow-2xl">
      {/* Decoración */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-0 right-0 w-64 h-64 bg-sky-500 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-brand-400 rounded-full blur-3xl"></div>
      </div>
