  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="prose prose-lg max-w-none prose-headings:text-navy-900 prose-a:text-sky-600 prose-a:no-underline hover:prose-a:underline">
        ...
        {/* Stat de apertura */}
        <div className="bg-navy-900 text-white rounded-2xl p-6 mb-8 border-l-4 border-sky-500">
          <p className="text-lg font-semibold leading-relaxed m-0">
            ¿Sabías que el{' '}
            <span className="text-sky-500 font-black">85% de los consumidores</span>{' '}
        ...
        <div className="my-8 rounded-2xl overflow-hidden shadow-lg not-prose">
          ...
          />
          <p className="text-xs text-slate-400 text-center bg-slate-50 py-2 px-4">
        ...
        <section id="sec-1" className="scroll-mt-24">
          ...
          <h3 className="h3-card text-navy-600 mt-8 mb-4">
          ...
          <div className="not-prose bg-brand-50 border-l-4 border-brand p-6 my-6 rounded-r-lg">
          ...
          <div className="not-prose bg-sky-50 border-l-4 border-sky-500 p-6 my-6 rounded-r-lg">
        ...
        <section id="sec-3" className="scroll-mt-24">
          ...
          <div className="not-prose space-y-4 my-6">
            {[
              ...
              <div key={item.num} className="flex gap-4 bg-white rounded-xl p-5 shadow-sm border border-slate-100">
                <span className="w-10 h-10 bg-navy-900 text-white rounded-full text-lg font-black flex items-center justify-center flex-shrink-0">
                  {item.num}
                </span>
                <div>
          ...
          <div className="not-prose bg-sky-50 border-l-4 border-sky-500 p-6 my-6 rounded-r-lg">
            <h4 className="font-bold text-navy-900 mb-2">Caso de éxito sensorial:</h4>
            <p className="text-navy-900">
        ...
        <section id="sec-4" className="scroll-mt-24">
          ...
          <div className="not-prose grid sm:grid-cols-2 gap-5 my-8">
            <div className="bg-white rounded-xl p-6 shadow-md border border-brand-100">
              <div className="flex items-center gap-3 mb-4">
                <span className="text-2xl">👔</span>
                <div>
                  <h4 className="font-bold text-navy-900">El Ejecutivo Lógico</h4>
                  <p className="text-xs text-slate-500">Audiencia B2B — Prefrontal Cortex dominante</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md border border-brand-100">
              <div className="flex items-center gap-3 mb-4">
                <span className="text-2xl">🎨</span>
                <div>
                  <h4 className="font-bold text-navy-900">El Creativo Emocional</h4>
                  <p className="text-xs text-slate-500">Audiencia Lifestyle — Amígdala activa</p>
                </div>
              </div>
              <p className="text-sm text-slate-500 mb-3">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md border border-sky-100">
              <div className="flex items-center gap-3 mb-4">
                <span className="text-2xl">🏡</span>
                <div>
                  <h4 className="font-bold text-navy-900">El Amante del Hogar</h4>
                  <p className="text-xs text-slate-500">Audiencia Family — Seguridad</p>
                </div>
              </div>
              <p className="text-sm text-slate-500 mb-3">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md border border-sky-100">
              <div className="flex items-center gap-3 mb-4">
                <span className="text-2xl">🌱</span>
                <div>
                  <h4 className="font-bold text-navy-900">El Eco-Consciente</h4>
                  <p className="text-xs text-slate-500">Audiencia Sostenible — Sistema de Valores</p>
                </div>
              </div>
              <p className="text-sm text-slate-500 mb-3">
        ...
        <section id="sec-5" className="scroll-mt-24">
          ...
          <div className="not-prose bg-navy-900 text-white rounded-2xl p-6 my-6">
            <h4 className="text-sky-500 font-bold text-lg mb-4">Regla 80/20 en Artículos Promocionales</h4>
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="bg-white/10 rounded-xl p-4">
                <p className="font-bold text-sky-500 mb-1">80% — Valor para el usuario</p>
                <p className="text-sm text-brand-100">Diseño, utilidad, frase que ama.</p>
              </div>
              <div className="bg-white/10 rounded-xl p-4">
                <p className="font-bold text-brand-100 mb-1">20% — Marca</p>
                <p className="text-sm text-brand-100">Sutil, elegante, grabado en bajo relieve o en el interior.</p>
              </div>
            </div>
          </div>
            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="bg-navy-900 text-white">
                  ...
                  <th className="p-3 text-left text-danger-50">❌ Copy Malo</th>
                  <th className="p-3 text-left text-sky-300 rounded-tr-lg">✅ Copy Bueno</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={i} className={i % 2 === 0 ? 'bg-slate-50' : 'bg-white'}>
                    <td className="p-3 font-semibold text-navy-900 border-b border-slate-100">{product}</td>
                    <td className="p-3 text-danger-600 border-b border-slate-100">{bad}</td>
                    <td className="p-3 text-brand-600 border-b border-slate-100">{good}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section id="sec-6" className="scroll-mt-24">
          ...
          <div className="not-prose space-y-5 my-6">
            <div className="bg-white rounded-xl p-6 shadow-md border-l-4 border-brand">
              <h3 className="h3-card text-navy-900 mb-2">🔌 1. Tecnología Vestible No Digital</h3>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md border-l-4 border-sky-500">
              <h3 className="h3-card text-navy-900 mb-2">📦 2. El &ldquo;Unboxing&rdquo; Emocional</h3>
              <p className="text-slate-700">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md border-l-4 border-sky-500">
              <h3 className="h3-card text-navy-900 mb-2">🍷 3. El Giveaway Experiencial</h3>
              <p className="text-slate-700">
        ...
        <section id="sec-7" className="scroll-mt-24">
          ...
          <div className="not-prose grid sm:grid-cols-3 gap-4 my-6">
            {[
              ...
              <div
                key={item.num}
                className="bg-gradient-to-br from-brand-50 to-white rounded-xl p-5 border border-brand-100 shadow-sm"
              >
                <span className="w-8 h-8 bg-navy-900 text-white rounded-full text-sm font-black flex items-center justify-center mb-3">
                  {item.num}
                </span>
                <p className="font-bold text-navy-900 text-sm mb-2">{item.q}</p>
        ...
        <section id="sec-8" className="scroll-mt-24">
          ...
          <div className="not-prose space-y-3 my-6">
            {[
              ...
              <div key={item.term} className="flex gap-4 bg-white rounded-xl p-5 shadow-sm border border-slate-100">
                <span className="bg-navy-900 text-white text-xs font-bold px-3 py-1 rounded-lg h-fit whitespace-nowrap flex-shrink-0">
                  {item.term}
                </span>
                <div>
                  <p className="font-semibold text-navy-900 text-sm">{item.full}</p>
          ...
          <div className="not-prose space-y-4 my-6">
            <div className="bg-white rounded-xl p-6 shadow-md border border-slate-100">
              ...
              <p className="text-slate-700 text-sm">
                ...
                landing exclusiva:{' '}
                <code className="bg-slate-100 px-1 rounded text-xs">tuplan/regalo</code>. Así sabrás el tráfico
        ...
        <section id="sec-10" className="scroll-mt-24">
          ...
          <div className="not-prose space-y-4">
            <div className="bg-white rounded-xl p-6 shadow-md border border-slate-100">
              <h4 className="font-bold text-navy-900 mb-3">¿Calidad asiática barata o europea cara?</h4>
              <p className="text-slate-700 text-sm">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md border border-slate-100">
              <h4 className="font-bold text-navy-900 mb-3">¿Uno caro para pocos o muchos baratos?</h4>
              <p className="text-slate-700 text-sm">
        ...
        <section id="sec-11" className="scroll-mt-24">
          ...
          <div className="not-prose bg-gradient-to-r from-navy-900 to-navy-600 rounded-2xl p-8 my-8 text-center">
            ...
            <Link
              href="/tienda/"
              className="inline-flex items-center gap-2 bg-sky-500 hover:bg-sky-600 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 no-underline"
            >
