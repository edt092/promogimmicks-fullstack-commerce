...
function ChristmasCarousel() {
  ...
  return (
    <div
      className="my-12 bg-gradient-to-br from-danger-600 via-danger-600 to-navy-900 rounded-3xl overflow-hidden shadow-2xl relative"
    ...
    >
      ...
      <div className="relative p-8 md:p-10">
        ...
        <div className="text-center mb-8">
          ...
          <h3 className="h2-section text-white mb-2">
            Ideas para tu Campaña Navideña
          </h3>
          <p className="text-danger-50">Productos perfectos para regalos de fin de año</p>
        </div>
        ...
        <div className="relative">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-10 bg-white/90 hover:bg-white text-danger-600 p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110"
            aria-label="Anterior"
          >
            <ChevronLeft size={24} />
          </button>
            ...
            >
              {products.map((product) => (
                ...
                >
                  ...
                  <div className="p-4">
                    <h4 className="text-white font-semibold text-sm line-clamp-2 mb-2 group-hover:text-sky-300 transition-colors">
                      {product.nombre}
                    </h4>
                    <span className="text-danger-50 text-xs">{product.categoria}</span>
                    <button
                      onClick={(e) => handleCotizar(e, product.nombre)}
                      className="w-full mt-3 bg-sky-500 hover:bg-sky-600 text-white text-xs py-2.5 rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
                    >
                      <Gift size={14} />
                      Cotizar Regalo
                    </button>
          ...
          <button
            onClick={nextSlide}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-10 bg-white/90 hover:bg-white text-danger-600 p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110"
        ...
        <div className="text-center mt-8">
          <Link
            href="/tienda/"
            className="inline-flex items-center gap-2 bg-white hover:bg-slate-100 text-danger-600 px-8 py-3 rounded-xl font-bold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
            <ShoppingBag size={18} />
...
function ChristmasCTA({
  ...
  if (variant === 'gift') {
    return (
      <div className="my-10 bg-gradient-to-r from-danger-600 to-danger-600 rounded-2xl overflow-hidden shadow-xl relative">
        ...
        <div className="relative p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="h2-section text-white">
          ...
          <Link
            href="/tienda/"
            className="bg-white hover:bg-slate-100 text-danger-600 px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center gap-2"
          >
            <TreePine size={20} />
            Ver Regalos
          </Link>
  ...
  if (variant === 'whatsapp') {
    return (
      <div className="my-10 bg-gradient-to-r from-sky-600 to-brand-600 rounded-2xl overflow-hidden shadow-xl">
        <div className="p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <button
            ...
            className="bg-white hover:bg-slate-100 text-sky-600 px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center gap-2"
          >
  ...
  if (variant === 'eco') {
    return (
      <div className="my-10 bg-gradient-to-r from-sky-600 to-sky-600 rounded-2xl overflow-hidden shadow-xl">
        <div className="p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 bg-white/20 rounded-full flex items-center justify-center">
  ...
  // Primary
  return (
    <div className="my-12 relative overflow-hidden rounded-3xl bg-gradient-to-br from-danger-600 via-danger-600 to-navy-900 shadow-2xl">
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-0 right-0 w-64 h-64 bg-sky-500 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-sky-400 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative p-8 md:p-12 text-center">
        <span className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-medium mb-6 border border-white/20">
          <TreePine size={16} className="text-sky-400" />
          Navidad 2025
        </span>

        <h3 className="h1-display text-white mb-4">
          {title || "Haz que tu Marca Brille esta Navidad"}
        </h3>

        <p className="text-danger-50 text-lg max-w-2xl mx-auto mb-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/tienda/"
            className="bg-sky-500 hover:bg-sky-600 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center justify-center gap-2"
          >
            <Gift size={20} />
...
function ChristmasProductShowcase({
  ...
  title,
  subtitle,
  bgColor = 'from-slate-900 to-slate-900'
}: {
      ...
      <div className="p-6 md:p-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            {subtitle && <p className="text-slate-200 mt-1">{subtitle}</p>}
          </div>
          <Link
            href="/tienda/"
            className="text-sky-500 hover:text-sky-300 font-medium flex items-center gap-1 text-sm"
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {products.slice(0, 4).map((product) => (
            ...
            >
              ...
              <div className="p-3">
                <h4 className="text-white font-semibold text-sm line-clamp-2 mb-1 group-hover:text-sky-300 transition-colors">
                  {product.nombre}
                </h4>
                <span className="text-slate-400 text-xs">{product.categoria}</span>
                <button
                  onClick={(e) => handleCotizar(e, product.nombre)}
                  className="w-full mt-2 bg-sky-500 hover:bg-sky-600 text-white text-xs py-2 rounded-lg font-medium transition-colors"
                >
                  Cotizar
                </button>
              </div>
    ...
    <>
      ...
      <div className="mb-10 bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
        <button
          ...
          className="w-full flex items-center justify-between p-6 bg-gradient-to-r from-danger-50 to-sky-50 hover:from-danger-50 hover:to-sky-100 transition-colors"
        >
          <div className="flex items-center gap-3">
            <TreePine className="text-sky-600" size={24} />
            <h2 className="h3-card text-slate-900">Tabla de Contenidos</h2>
          </div>
          {tocOpen ? <ChevronUp size={24} className="text-danger-600" /> : <ChevronDown size={24} className="text-danger-600" />}
        </button>

        {tocOpen && (
          <nav className="p-6 pt-0">
            <ol className="space-y-2 text-slate-700">
              <li><a href="#intro" className="hover:text-danger-600 transition-colors flex items-center gap-2"><span className="w-6 h-6 bg-danger-50 text-danger-600 rounded-full text-xs flex items-center justify-center font-bold">1</span> Introducción</a></li>
              <li><a href="#guia-definitiva" className="hover:text-danger-600 transition-colors flex items-center gap-2"><span className="w-6 h-6 bg-danger-50 text-danger-600 rounded-full text-xs flex items-center justify-center font-bold">2</span> Guía Definitiva para Impulsar tu Marca</a></li>
              <li><a href="#beneficios" className="hover:text-danger-600 transition-colors flex items-center gap-2"><span className="w-6 h-6 bg-danger-50 text-danger-600 rounded-full text-xs flex items-center justify-center font-bold">3</span> Beneficios Clave para tu Negocio</a></li>
              <li><a href="#ideas-creativas" className="hover:text-danger-600 transition-colors flex items-center gap-2"><span className="w-6 h-6 bg-danger-50 text-danger-600 rounded-full text-xs flex items-center justify-center font-bold">4</span> Ideas Creativas para 2025</a></li>
              <li><a href="#segmentacion" className="hover:text-danger-600 transition-colors flex items-center gap-2"><span className="w-6 h-6 bg-danger-50 text-danger-600 rounded-full text-xs flex items-center justify-center font-bold">5</span> Segmentación por Público Objetivo</a></li>
              <li><a href="#personalizacion" className="hover:text-danger-600 transition-colors flex items-center gap-2"><span className="w-6 h-6 bg-danger-50 text-danger-600 rounded-full text-xs flex items-center justify-center font-bold">6</span> Cómo Personalizar tus Artículos</a></li>
              <li><a href="#proveedores" className="hover:text-danger-600 transition-colors flex items-center gap-2"><span className="w-6 h-6 bg-danger-50 text-danger-600 rounded-full text-xs flex items-center justify-center font-bold">7</span> Dónde Comprar</a></li>
              <li><a href="#presupuesto" className="hover:text-danger-600 transition-colors flex items-center gap-2"><span className="w-6 h-6 bg-danger-50 text-danger-600 rounded-full text-xs flex items-center justify-center font-bold">8</span> Presupuesto y Optimización</a></li>
              <li><a href="#distribucion" className="hover:text-danger-600 transition-colors flex items-center gap-2"><span className="w-6 h-6 bg-danger-50 text-danger-600 rounded-full text-xs flex items-center justify-center font-bold">9</span> Estrategias de Distribución</a></li>
              <li><a href="#medicion" className="hover:text-danger-600 transition-colors flex items-center gap-2"><span className="w-6 h-6 bg-danger-50 text-danger-600 rounded-full text-xs flex items-center justify-center font-bold">10</span> Medición del Éxito</a></li>
              <li><a href="#errores" className="hover:text-danger-600 transition-colors flex items-center gap-2"><span className="w-6 h-6 bg-danger-50 text-danger-600 rounded-full text-xs flex items-center justify-center font-bold">11</span> Errores Comunes y Cómo Evitarlos</a></li>
              <li><a href="#sostenibles" className="hover:text-danger-600 transition-colors flex items-center gap-2"><span className="w-6 h-6 bg-danger-50 text-danger-600 rounded-full text-xs flex items-center justify-center font-bold">12</span> Opciones Sostenibles</a></li>
              <li><a href="#faq" className="hover:text-danger-600 transition-colors flex items-center gap-2"><span className="w-6 h-6 bg-danger-50 text-danger-600 rounded-full text-xs flex items-center justify-center font-bold">13</span> Preguntas Frecuentes</a></li>
              <li><a href="#conclusion" className="hover:text-danger-600 transition-colors flex items-center gap-2"><span className="w-6 h-6 bg-danger-50 text-danger-600 rounded-full text-xs flex items-center justify-center font-bold">14</span> Conclusión</a></li>
            </ol>
          </nav>
        )}
      </div>
      ...
      <div className="prose prose-lg max-w-none prose-headings:text-slate-900 prose-a:text-danger-600 prose-a:no-underline hover:prose-a:underline">
        ...
        <section id="guia-definitiva" className="scroll-mt-24">
          <h2 className="h2-section text-slate-900 mt-12 mb-6 flex items-center gap-3">
          ...
          <h3 className="h3-card text-slate-900 mt-8 mb-4">Elige Artículos que Resuenen con tu Audiencia</h3>
          ...
          <div className="bg-danger-50 border-l-4 border-danger-500 p-6 my-6 rounded-r-lg">
            <h4 className="font-bold text-danger-600 mb-3 flex items-center gap-2">
              <Target size={20} />
              Claves para elegir el regalo perfecto:
            </h4>
            <ul className="space-y-2 text-slate-700">
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-5 h-5 text-danger-500 mt-0.5 flex-shrink-0" />
          ...
          <h3 className="h3-card text-slate-900 mt-8 mb-4">Personalización Creativa: Más Allá del Logo</h3>
        ...
        <section id="beneficios" className="scroll-mt-24">
          ...
          <div className="grid md:grid-cols-3 gap-6 my-8">
            <div className="bg-white rounded-xl p-6 shadow-md border border-slate-100 hover:shadow-lg transition-shadow">
              ...
              <h4 className="font-bold text-slate-900 mb-2">Visibilidad de Marca</h4>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md border border-slate-100 hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 bg-danger-50 rounded-full flex items-center justify-center mb-4">
                <Heart className="text-danger-600" size={24} />
              </div>
              <h4 className="font-bold text-slate-900 mb-2">Fortalece Relaciones</h4>
              <p className="text-slate-500 text-sm">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md border border-slate-100 hover:shadow-lg transition-shadow">
              ...
              <h4 className="font-bold text-slate-900 mb-2">Impulsa Ventas</h4>
              <p className="text-slate-500 text-sm">
        ...
        <section id="ideas-creativas" className="scroll-mt-24">
          ...
          <h3 className="h3-card text-slate-900 mt-8 mb-4">Kits de Experiencias Navideñas Personalizadas</h3>
          ...
          <h3 className="h3-card text-slate-900 mt-8 mb-4">Artículos Eco-Amigables con Toque Navideño</h3>
          ...
          <h3 className="h3-card text-slate-900 mt-8 mb-4">Tecnología Útil con Diseño Festivo</h3>
        ...
        <ChristmasProductShowcase
          ...
          bgColor="from-navy-900 to-navy-600"
        />
        ...
        <section id="segmentacion" className="scroll-mt-24">
          ...
          <div className="grid md:grid-cols-2 gap-6 my-8">
            <div className="bg-gradient-to-br from-brand-50 to-brand-100 rounded-xl p-6 border border-brand-100">
              <h4 className="font-bold text-navy-900 mb-4 text-lg flex items-center gap-2">
                <Users size={20} />
                Para Empleados
              </h4>
            ...
            <div className="bg-gradient-to-br from-danger-50 to-danger-50 rounded-xl p-6 border border-danger-50">
              <h4 className="font-bold text-danger-600 mb-4 text-lg flex items-center gap-2">
                <Heart size={20} />
                Para Clientes
              </h4>
              <ul className="space-y-2 text-slate-700 text-sm">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="text-danger-500" size={16} />
        ...
        <section id="personalizacion" className="scroll-mt-24">
          ...
          <h3 className="h3-card text-slate-900 mt-8 mb-4">El Poder del Diseño Personalizado</h3>
          ...
          <h3 className="h3-card text-slate-900 mt-8 mb-4">Mensajes que Conectan</h3>
        ...
        <section id="proveedores" className="scroll-mt-24">
          ...
          <h3 className="h3-card text-slate-900 mt-8 mb-4">Proveedores Especializados</h3>
          ...
          <div className="bg-sky-50 border-l-4 border-sky-500 p-6 my-6 rounded-r-lg">
            <h4 className="font-bold text-navy-900 mb-3">Tips al elegir proveedor:</h4>
        ...
        <section id="presupuesto" className="scroll-mt-24">
          ...
          <h3 className="h3-card text-slate-900 mt-8 mb-4">Calculando tu Presupuesto Base</h3>
          ...
          <h3 className="h3-card text-slate-900 mt-8 mb-4">Estrategias de Optimización</h3>
        ...
        <ChristmasProductShowcase
          ...
          bgColor="from-danger-600 to-danger-600"
        />
        ...
        <section id="distribucion" className="scroll-mt-24">
          ...
          <h3 className="h3-card text-slate-900 mt-8 mb-4">Distribución Directa</h3>
          ...
          <h3 className="h3-card text-slate-900 mt-8 mb-4">Eventos Navideños y Ferias</h3>
        ...
        <section id="medicion" className="scroll-mt-24">
          ...
          <h3 className="h3-card text-slate-900 mt-8 mb-4">KPIs Clave</h3>

          <div className="grid md:grid-cols-3 gap-4 my-6">
            <div className="bg-white rounded-lg p-4 shadow-md border border-slate-100 text-center">
              <Award className="w-8 h-8 mx-auto text-sky-500 mb-2" />
              <h5 className="font-bold text-slate-900">Tasa de Conversión</h5>
              <p className="text-slate-500 text-sm">Acciones realizadas por destinatarios</p>
            </div>
            <div className="bg-white rounded-lg p-4 shadow-md border border-slate-100 text-center">
              <TrendingUp className="w-8 h-8 mx-auto text-sky-500 mb-2" />
              <h5 className="font-bold text-slate-900">ROI</h5>
              <p className="text-slate-500 text-sm">Retorno de la inversión</p>
            </div>
            <div className="bg-white rounded-lg p-4 shadow-md border border-slate-100 text-center">
              <Star className="w-8 h-8 mx-auto text-brand mb-2" />
              <h5 className="font-bold text-slate-900">Visibilidad</h5>
              <p className="text-slate-500 text-sm">Alcance de marca logrado</p>
            </div>
          </div>

          <h3 className="h3-card text-slate-900 mt-8 mb-4">Herramientas de Seguimiento</h3>
        ...
        <section id="errores" className="scroll-mt-24">
          <h2 className="h2-section text-slate-900 mt-12 mb-6 flex items-center gap-3">
            <HelpCircle className="text-danger-600" />
          ...
          <div className="space-y-4 my-6">
            <div className="bg-danger-50 rounded-xl p-5 border border-danger-50">
              <h4 className="font-bold text-danger-600 mb-2">No considerar el público objetivo</h4>
              <p className="text-slate-700 text-sm">
                Investiga a tu audiencia, segmenta y ofrece opciones que se adapten a sus gustos.
              </p>
            </div>
            <div className="bg-danger-50 rounded-xl p-5 border border-danger-50">
              <h4 className="font-bold text-danger-600 mb-2">Descuidar la calidad y utilidad</h4>
              <p className="text-slate-700 text-sm">
                Prioriza durabilidad, elige artículos útiles y evita productos genéricos.
              </p>
            </div>
            <div className="bg-danger-50 rounded-xl p-5 border border-danger-50">
              <h4 className="font-bold text-danger-600 mb-2">Ignorar la sostenibilidad</h4>
              <p className="text-slate-700 text-sm">
        ...
        <section id="sostenibles" className="scroll-mt-24">
          ...
          <h3 className="h3-card text-slate-900 mt-8 mb-4">Materiales Sostenibles</h3>

          <div className="grid md:grid-cols-2 gap-4 my-6">
            <div className="flex items-center gap-3 bg-sky-50 p-4 rounded-lg">
              <Leaf className="text-sky-600 flex-shrink-0" />
              <div>
          ...
          <h3 className="h3-card text-slate-900 mt-8 mb-4">Ideas Eco-Friendly</h3>
        ...
        <ChristmasProductShowcase
          ...
          bgColor="from-navy-900 to-navy-900"
        />
        ...
        <section id="faq" className="scroll-mt-24">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md border border-slate-100">
              <h4 className="font-bold text-slate-900 mb-3 flex items-center gap-2">
                <Gift className="text-danger-500" size={20} />
        ...
        <section id="conclusion" className="scroll-mt-24">
          <h2 className="h2-section text-slate-900 mt-12 mb-6">
            Conclusión
          </h2>
          ...
          <div className="bg-gradient-to-r from-danger-600 to-navy-900 rounded-2xl p-8 my-8 text-center">
            <h3 className="h2-section text-white mb-4 flex items-center justify-center gap-3">
              <TreePine className="text-sky-400" />
              ¡Haz que esta Navidad sea inolvidable!
            </h3>
            <p className="text-danger-50 mb-6">
